...
const PrivacyPolicy: NextPage<PrivacyPolicyProps> = ({}) => {
    return (
        <div className='flex flex-col h-full justify-center max-w-7xl w-full items-center mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='py-16 space-y-6'>
                <div className='space-y-3'>
                    <p className='font-bold text-xl mb-3'>Privacy Policy</p>
                    <p>
                        Akash Kesharwani built the YT Retention Tools app as an Open Source app. This SERVICE is provided by
                        Akash Kesharwani at no cost and is intended for use as is.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        which are accessible at YT Retention Tools unless otherwise defined in this Privacy Policy.
                    </p>
                </div>
                <div className='space-y-3'>
                    <p className='font-bold text-xl mb-3'>Information Collection and Use</p>
                    <p>
                ...
                <div className='space-y-3'>
                    <p className='font-bold text-xl mb-3'>Log Data</p>
                    <p>
                ...
                <div className='space-y-3'>
                    <p className='font-bold text-xl mb-3'>Cookies</p>
                    <p>
                ...
                <div className='space-y-3'>
                    <p className='font-bold text-xl mb-3'>Service Providers</p>
                ...
                <div className='space-y-3'>
                    <p className='font-bold text-xl mb-3'>Security</p>
                    <p>
                ...
                <div className='space-y-3'>
                    <p className='font-bold text-xl mb-3'>Links to Other Sites</p>
                    <p>
                ...
                <div className='space-y-3'>
                    <p className='font-bold text-xl mb-3'>Children’s Privacy</p>
                    <div>
                        <p>
                ...
                <div className='space-y-3'>
                    <p className='font-bold text-xl mb-3'>Changes to This Privacy Policy</p>
                    <p>
